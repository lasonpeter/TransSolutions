...
namespace TransSolutions.Infrastructure.Migrations
{
    ...
    [Migration("20260416173256_Models3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransSolutions.Domain.Models.BusinessLogic.Driver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TransSolutions.Domain.Models.Auth.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TransSolutions.Domain.Models.Auth.RefreshTokens", b =>
                {
                    b.HasOne("TransSolutions.Domain.Models.Auth.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TransSolutions.Domain.Models.BusinessLogic.Driver", b =>
                {
                    b.HasOne("TransSolutions.Domain.Models.Auth.AppUser", "User")
                        .WithOne("Driver")
                        .HasForeignKey("TransSolutions.Domain.Models.BusinessLogic.Driver", "AppUserId")
